...
function App() {
  ...
  return (
    <>
      <div
        className="mx-auto bg-white shadow border rounded mt-5 d-flex flex-column justify-content-center align-items-center"
        style={{ width: "60%", minHeight: "20rem", height: "auto" }}
      >
